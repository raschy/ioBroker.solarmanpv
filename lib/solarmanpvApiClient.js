...
wrapper.getToken = async function () {
	...
	console.log(`[getToken] hash: ${hash}`);
	...
	if (wrapper.companyName == '' || wrapper.companyName == undefined) {
		return promises1;
	}
	...
	return promises2; //old promises1
};
...
wrapper.axios.interceptors.response.use(
	async response => {
